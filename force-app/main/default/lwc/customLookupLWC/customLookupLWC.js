...
export default class CustomLookupLwc extends LightningElement {
   ...
   // initial function to populate default selected lookup record if defaultRecordId provided  
    ...
    @wire(fetchLookupData, { searchKey: '$searchKey' , sObjectApiName : '$sObjectApiName', whereFieldApiName:'$wherefieldapiname', wherefieldValue:'$wherefieldvalue'})
     searchResult(value) {
  ...
  // update searchKey property on input field change  
    handleKeyChange(event) {
        ...
        console.log('+++inside handleKeyChange of customlookupLwc js');
        this.isSearchLoading = true;
        window.clearTimeout(this.delayTimeout);
        console.log('This is searching'+event);
